...
<https://github.com/holepunchto/bare-make> is used for compiling the native bindings in [`binding.rs`](binding.rs) and [`binding.c`](binding.c). Start by installing the tool globally:
